...
const siteConfig: SiteConfig = {
  ...
  pageDescriptions: {
    ...
    prices: 'Вартість фотосесій в Одесі — Юлія Селецька. Від 7500 грн, тривалість 2 години. Вагітність, новонароджені, сім\'ї, жіночий портрет.',
    portfolio:
      'Портфоліо фотографа Юлії Селецької — Одеса. Фотосесії вагітності, новонароджених, сімейні та жіночі.',
    ...
    contact: "Зв'яжіться з фотографом Юлією Селецькою — телефон, Viber, Telegram, Instagram. Одеса.",
